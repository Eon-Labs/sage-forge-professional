...
class ArrowDataManager:
    ...
    def fetch_real_market_data(
        ...
        try:
            console.print(f"[cyan]🌐 Fetching real market data using Data Source Manager...[/cyan]")
            ...
            start_time = end_time - timedelta(hours=limit // 60)  # Approximate hours based on minutes
