...
class BacktestFundingIntegrator:
    ...
    async def prepare_backtest_funding(
        ...
        backtest_start = datetime.fromtimestamp(bars[0].ts_init / 1_000_000_000, tz=timezone.utc)
        backtest_end = datetime.fromtimestamp(bars[-1].ts_init / 1_000_000_000, tz=timezone.utc)
