...
async def main():
    ...
    # Use EMACrossConfig as a compatible configuration - our strategy will adapt
    strategy_config = EMACrossConfig(
        instrument_id=instrument.id,
        bar_type=bar_type,
        fast_ema_period=10,  # Not used by our strategy, but required by config
        slow_ema_period=21,  # Not used by our strategy, but required by config
    ...
    strategy = AdaptiveProfitableStrategy(config=strategy_config)
